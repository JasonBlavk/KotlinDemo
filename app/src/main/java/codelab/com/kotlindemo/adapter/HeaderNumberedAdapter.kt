...
class HeaderNumberedAdapter(private val header: View, count: Int) : RecyclerView.Adapter<TextViewHolder>() {
    ...
    init {
        ...
        if (header == null) {
            ...
            throw IllegalArgumentException("header may not be null") as Throwable
        }

        this.labels = ArrayList<String>(count)
    ...
    override fun onBindViewHolder(holder: TextViewHolder, position: Int) {
        ...
        holder.textView.setOnClickListener {
            Toast.makeText(holder.textView.context, label, Toast.LENGTH_SHORT).show()
        }
